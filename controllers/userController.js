...
/*
const logout = asyncHandler(async (req, res) => {
    // Verifica se existe o cookie "accessToken" e "refreshToken" nas requisições enviadas pelo cliente
    const cookies = req.cookies;
    console.log(cookies);
    const accessTokenCookieName = "accesstoken";
    const refreshTokenCookieName = "refreshToken";
  
    // Limpa o cookie "accessToken" na resposta, se existir
    if (cookies[accessTokenCookieName]) {
